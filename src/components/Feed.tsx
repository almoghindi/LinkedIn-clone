...
const Feed = () => {
	...
	return (
		<FeedWrapper>
			...
			<Card className="card">
				<Post
					name="Web Development | Almog Hindi"
					...
					imgUrl="https://avatars.githubusercontent.com/u/102804545?s=400&u=54ecdef2b53ffed05868768e36b079642a43f3b3&v=4"
...
▸ GitHub Repo: https://github.com/almoghindi/Linkedin-clone
